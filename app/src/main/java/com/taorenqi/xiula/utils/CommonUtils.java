...
package com.taorenqi.xiula.utils;
...
public class CommonUtils {
    ...
    public static void showToast(String msg, int duration) {
        try {
            Toast.makeText(XiulaApp.getApp(), msg, duration).show();
        } catch (Exception e) {
...
//        return match.matches();
    ...
    public static String getUmengChannel() {
        ...
        String channel = "其他";
        try {
            ai = XiulaApp.getApp().getPackageManager().getApplicationInfo(XiulaApp.getApp().getPackageName(),
