...
import com.taorenqi.xiula.common.cache.ACache;
    ...
    private static boolean deleteDir(File dir) {
        if (dir != null && dir.isDirectory()) {
            ...
            for (int i = 0; i < children.length; i++) {
                if (StringUtils.equals(dir.getName(), ACache.CACHE_FOLDER_NAME)) {
                    continue;
                }
        ...
        try {
            ...
            for (int i = 0; i < fileList.length; i++) {
                ...
                if (fileList[i].isDirectory()) {
                    if (StringUtils.equals(fileList[i].getName(), ACache.CACHE_FOLDER_NAME)) {
                        continue;
                    }
